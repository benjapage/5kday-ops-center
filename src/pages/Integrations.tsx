...
export default function Integrations() {
  ...
  function connectShop(shop: string) {
    // Usa el endpoint que hace POST directo a Shopify con client_id + client_secret
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="space-y-3">
        ...
        <Card className="shadow-sm border-slate-100 bg-slate-50">
          <CardContent className="p-4">
            <p className="text-xs font-medium text-slate-600 mb-1">Como funciona</p>
            <ul className="text-xs text-slate-400 space-y-1 list-disc list-inside">
              <li>Al conectar, se obtiene el token automaticamente con las credenciales configuradas</li>
              <li>Se registra un webhook para recibir ordenes pagadas en tiempo real</li>
              <li>Los ingresos Shopify aparecen con badge verde en la seccion Financiero</li>
            </ul>
          </CardContent>
        </Card>
      </div>
